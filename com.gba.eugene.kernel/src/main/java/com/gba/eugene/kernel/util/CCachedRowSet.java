...
public class CCachedRowSet implements RowSet, CachedRowSet, Serializable {

    private static final long serialVersionUID = -365243261449861555L;
     ...
     *	@throws SQLException
     */
    public static RowSet getRowSet (ResultSet rs, SystemDatabase db) throws SQLException{
    /*
